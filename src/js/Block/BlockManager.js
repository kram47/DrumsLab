...
var BlockManager = (function () {
     ...
     * @param  {int} xStart - x position of note to to draw (from up-left corner)
     * @param  {int} yStart - y position of note to to draw (from up-left corner)
     * @return {void}
     */
    ...
    */
    ...
    /**
     * Dessine un temps
     * @param {array[Note]} notes - Liste des notes composant le temps à dessiner
     */
